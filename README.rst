...
===================================================
	elFinder4django is a django connector for `elFinder`_ file manager.
...
------------------------
	...
	#. copy the application folder called ``connector`` ( found in :file:`elfinder4django/elfindertest/connector` ) inside your django project. 
	...
	#. download elFinder **version 2.x** from `elFinder`_  site (**note:** currently in 2.0-beta) . extract it in :file:`connect/static` directory make sure you renamed it as ``elFinder``.
